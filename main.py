...
if __name__ == "__main__":
    print("First example :", count_possible_pairs(
        rebuild_adjacency_list(create_adjacency_list(move_pairs_to_clans(create_pairs(read_from_file('data.txt')))))))
    print("Second example :", count_possible_pairs(
        rebuild_adjacency_list(create_adjacency_list(move_pairs_to_clans(create_pairs(read_from_file('data2.txt')))))))
